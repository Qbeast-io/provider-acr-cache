...
// Package apis contains Kubernetes API for the AzureContainerRegistryExt provider.
package apis

import (
	"k8s.io/apimachinery/pkg/runtime"

	samplev1alpha1 "github.com/crossplane/provider-azurecontainerregistryext/apis/sample/v1alpha1"
