...
func main() {
	var (
		app            = kingpin.New(filepath.Base(os.Args[0]), "AzureContainerRegistryExt support for Crossplane.").DefaultEnvars()
	...
	kingpin.FatalIfError(apis.AddToScheme(mgr.GetScheme()), "Cannot add AzureContainerRegistryExt APIs to scheme")
